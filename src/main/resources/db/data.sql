...
insert into board_tb(title, content, user_id, created_at) values('title5', '내용5', 1, now());
insert into board_tb(title, content, user_id, created_at) values('title6', '내용6', 1, now());
insert into board_tb(title, content, user_id, created_at) values('title7', '내용7', 1, now());
